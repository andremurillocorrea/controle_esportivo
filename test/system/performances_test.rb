...
class PerformancesTest < ApplicationSystemTestCase
  ...
  test "creating a Performance" do
    ...
    fill_in "Distance", with: @performance.distance
    fill_in "Pool Length", with: @performance.pool_length
    fill_in "Style", with: @performance.style
    fill_in "Time", with: @performance.time
