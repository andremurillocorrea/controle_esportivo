...
class PerformancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performance" do
    assert_difference('Performance.count') do
      post performances_url, params: { performance: { date: @performance.date, distance: @performance.distance, pool_length: @performance.pool_length, style: @performance.style, time: @performance.time } }
    end
  ...
  test "should update performance" do
    patch performance_url(@performance), params: { performance: { date: @performance.date, distance: @performance.distance, pool_length: @performance.pool_length, style: @performance.style, time: @performance.time } }
