...
class FinancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create finance" do
    assert_difference('Finance.count') do
      post finances_url, params: { finance: { debt: @finance.debt, status: @finance.status, value: @finance.value } }
    end
  ...
  test "should update finance" do
    patch finance_url(@finance), params: { finance: { debt: @finance.debt, status: @finance.status, value: @finance.value } }
