...
class TreinosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treino" do
    assert_difference('Treino.count') do
      post treinos_url, params: { treino: { Data: @treino.Data, Descricao: @treino.Descricao } }
    end
  ...
  test "should update treino" do
    patch treino_url(@treino), params: { treino: { Data: @treino.Data, Descricao: @treino.Descricao } }
